    ...
    return (
        <div>
            <nav className={`flex flex-row gap-2 dark:bg-[#0A0A0B] dark:text-white`}>
                <a href="https://api.whatsapp.com/send/?phone=5541995117543&text&type=phone_number&app_absent=0" className={`col-span-2 h-11 border-2 flex items-center justify-center zapBtn dark:border-transparent md:px-11`}><h2 className="font-semibold">{whatsapp}</h2></a>
                <a href="https://www.linkedin.com/in/luis-gustavo-hedel-marchiore/" className={`h-11 border-2 flex items-center iconsBtn dark:bg-[#121214] dark:border-[#121214] dark:text-white dark:hover:bg-white dark:hover:text-black md:w-24`}><CiLinkedin className="w-full h-7" /></a>
                <a href="https://github.com/LuisGHM" className={`h-11 border-2 flex items-center iconsBtn dark:bg-[#121214] dark:border-[#121214] dark:text-white dark:hover:bg-white dark:hover:text-black md:w-24`}><FaGithub className="w-full h-7" /></a>
