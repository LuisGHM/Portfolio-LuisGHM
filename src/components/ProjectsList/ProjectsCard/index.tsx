...
export const ProjectsCard = ({ item, key }: ProjectsCardProps) => {
    ...
    const fetchData = async () => {
        try {
            ...
            if (projectName.includes("Projects") && projectName.includes("Name")) {
                return null;
            }   
                ...
                return (
                    <div className="flex flex-row" key={key}>
                        <div className="flex flex-col gap-6 max-w-[500px]">
                            ...
                            <p className="text-justify font-normal text-base text-[#495057] dark:text-[#868E96]">{projectDescription}</p>
